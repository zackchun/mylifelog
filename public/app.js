...
function loadAll() {
    ...
    .then(data => {
        ...
        for(let i=0;i<data.data.length;i++) {
          let string = '';
            // if (data.data[i].type == 'travel') {
              string= " # " + data.data[i].date + " [ " + data.data[i].type + " ] @ " + data.data[i].country + " / " + data.data[i].city + " => " + data.data[i].memo;
            // } else if (data.data[i].type == 'book') {
            //   string= " # " + data.data[i].date + " @ " + data.data[i].country + " / " + data.data[i].city + " => " + data.data[i].memo;
            // } else if (data.data[i].type == 'movie') {
            //   string= " # " + data.data[i].date + " @ " + data.data[i].country + " / " + data.data[i].city + " => " + data.data[i].memo;
            // }
